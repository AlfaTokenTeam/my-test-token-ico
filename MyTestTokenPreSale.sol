...
import "./MyTestToken.sol";

contract MyTestTokenPreSale {
    MyTestToken public token;
    ...
    function MyTestTokenPreSale(
        MyTestToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTestToken(_token);
        beneficiary = _beneficiary;
        alfatokenteam = _alfatokenteam;
        bonus = 30;
        price = 50;
        minSaleAmount = 1000000000000000000000;
    }
